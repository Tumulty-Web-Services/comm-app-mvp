...
passport.use( new LinkedInStrategy({
    ...
    const family_name = profile.name.family_name;
    ...
    if(existingUser) {
      ...
      const createdUser = await db.users.create({ family_name, givenName, email, linkedinId, picture_url, background, form_started });
