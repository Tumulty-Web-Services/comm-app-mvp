...
module.exports = (app) => {
  ...
  app.post('/voice/:responseId/transcribe/:questionIndex', urlencoded({ extended: true }), (req, response) => {
  ...
  app.post('/twilio/call/form/:phone', (req, res) => {
...
advanceSurvey = async (args, cb) => {
  ...
  function processInput(surveyResponse) {
    ...
    if (surveyResponse.responses === undefined) {
      ...
      const newResponses = surveyResponse.responses;
