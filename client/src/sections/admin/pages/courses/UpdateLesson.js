...
class AdmAddLesson extends Component {
    ...
    onSubmit = async () => {
        ...
        try {
          await Axios({
            method:'post',
            url:'/api/course_lessons/update/' + this.props.match.params.id,
            data: {
               ...this.state.lesson,
          ...
          createNotificationStandard('<span class="text-success">Success</span>', 'Lesson updated successfully!.', 2000)
    ...
    async componentDidMount() {
        ...
        try {
          const res = await Axios({
            method:'get',
            url:'/api/course_lessons/get/' + this.props.match.params.id,
        ...
        return (
                ...
                <div className="content-raised">
                    ...
                    <div className="page-top">
                        ...
                        <Link to={"/admin/lessons/view/" + this.state.lesson.module_id}><i className="material-icons">arrow_back</i>Lesson View</Link>

                        <button className="btn btn-success" onClick={() => this.onSubmit()}>Update</button>
                        

                        </div>
                        <h2 className="title">Update Lesson: {this.state.lesson.name}</h2>
                        <p><span className="text-success">Lesson Order</span> {this.state.lesson.order}</p>
